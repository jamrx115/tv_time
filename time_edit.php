...
if ($request->isPost()) {
  ...
  $cl_activity = $time_rec['activity_id'];
  $cl_start = $time_rec['start'];
  $cl_finish = $time_rec['finish'];
  $cl_real_finish = $time_rec['real_finish'];
...
if ($request->isPost()) {
  ...
  if ($request->getParameter('btn_save')) {
    ...
    if ($err->no()) {
      ...
      if($api->setNewTime($cl_start, $cl_finish) && $api->updateTaskTime($time_rec['phprojekt_id'], $cl_activity, $cl_date, $cl_note,$cl_real_finish)) {
